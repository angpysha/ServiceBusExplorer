...
- T011 may run beside T010 because its send model/service/view files are disjoint.
...
- T018 and T019 may run together because session and deferred service files are disjoint; both
  finish before T020.
- T022 and T024 may run together. T023 begins after T022 where `MainView.axaml` would otherwise
  overlap; T025 begins after both accessibility and duration work.
